...
class ResultGenerator:
    ...
    def show_result(self, board_cost: float):
        ...
        cv2.putText(annotated, info, (20, h - y_offset - 120), font, font_scale, (0, 0, 0), thickness + 8)
        cv2.putText(annotated, info2, (20, h - y_offset), font, font_scale, (0, 0, 0), thickness + 8)

        # Dibujar texto blanco encima
        cv2.putText(annotated, info, (20, h - y_offset - 120), font, font_scale, (255, 255, 255), thickness)
